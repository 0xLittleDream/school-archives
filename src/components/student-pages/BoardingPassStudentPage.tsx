          ...
          <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-border/50">
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-16 bg-primary text-primary-foreground flex lg:flex-col items-center justify-center py-4 lg:py-8 gap-2">
                ...
                <span className="lg:writing-mode-vertical lg:rotate-180 text-xs font-bold tracking-[0.2em] uppercase whitespace-nowrap"
              ...
              <div className="flex-1 p-6 md:p-8 lg:p-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-semibold text-foreground">NCS, SVN COLONY - ASSEMBLY AREA</p>
                  </div>
                </div>
                  ...
                  <div className="mb-8 p-4 bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl border border-primary/10">
                    <div className="flex flex-wrap justify-center gap-2">
                      {traits.map((trait, index) => (
                        <span 
                          key={index}
                          className="px-4 py-2 bg-primary/10 text-primary font-bold text-lg uppercase tracking-wider rounded-full"
                        >
                          {trait}
                        </span>
                      ))}
                ...
                {student.future_dreams && (
                  <div className="mb-8 p-6 bg-secondary/30 rounded-xl border-l-4 border-primary">
              ...
              <div className="lg:w-20 bg-primary text-primary-foreground flex lg:flex-col items-center justify-center py-4 lg:py-8 gap-3">
                ...
                <span className="lg:writing-mode-vertical text-sm font-bold tracking-[0.15em] uppercase whitespace-nowrap text-center"
            ...
            {student.photo_url && (
              <div className="absolute -right-4 -bottom-4 lg:right-24 lg:top-1/2 lg:-translate-y-1/2 w-32 h-40 md:w-40 md:h-52 lg:w-48 lg:h-64 rounded-2xl overflow-hidden shadow-2xl border-4 border-white rotate-3 hidden md:block">
                <img 
